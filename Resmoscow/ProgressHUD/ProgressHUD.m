...
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[self shared] hudCreate:nil image:nil spin:NO hide:YES interaction:YES];
    });
}
...
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[self shared] hudCreate:status image:nil spin:NO hide:YES interaction:YES];
    });
}
...
{
    dispatch_async(dispatch_get_main_queue(), ^{
        [[self shared] hudCreate:status image:nil spin:NO hide:YES interaction:interaction];
    });
}
